...
module namespace model="http://www.tei-c.org/pm/models/time-us/print";
    ...
    $input !         (
            ...
            return
                        ...
                        if ($parameters?header='short') then
                            ...
                            if ($parameters?mode="metadata") then
                                (
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader2", css:map-rend-to-class(.)), $content),
                                    let $params := 
                                        map {
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader3", css:map-rend-to-class(.)), $content),
                                    let $params := 
                                        map {
                                            "content": .
                                        }
                                    ...
                                    return
                                                                        html:text(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader4", css:map-rend-to-class(.)), $content),
                                    let $params := 
                                        map {
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader5", css:map-rend-to-class(.)), $content)
                                )

                            else
                                if ($parameters?mode='title') then
                                    html:inline($config, ., ("tei-teiHeader6", css:map-rend-to-class(.)), (fileDesc/titleStmt/title[1]))
                                else
                                    html:metadata($config, ., ("tei-teiHeader9", css:map-rend-to-class(.)), .)
                    ...
                    case element(pb) return
                        html:omit($config, ., css:get-rendition(., ("tei-pb", css:map-rend-to-class(.))), .)
                    ...
                    case element(w) return
                        ...
                        return
                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-w", css:map-rend-to-class(.)), $content)
                    ...
                    case element(publicationStmt) return
                        if ($parameters?header='short') then
                            html:block($config, ., ("tei-publicationStmt1", css:map-rend-to-class(.)), p)
                        else
                            (: More than one model without predicate found for ident publicationStmt. Choosing first one. :)
                            html:block($config, ., ("tei-publicationStmt2", css:map-rend-to-class(.)), availability/licence)
                        ...
                        if ($parameters?mode='title') then
                            ...
                            if ($parameters?header='short') then
                                (
                                    ...
                                    html:block($config, ., ("tei-titleStmt6", css:map-rend-to-class(.)), editor)
                                )
                    ...
                    case element(fileDesc) return
                        if ($parameters?header='short') then
                            (
                                ...
                                html:block($config, ., ("tei-fileDesc2", "header-short", css:map-rend-to-class(.)), sourceDesc),
                    ...
                    case element(body) return
                        (
                            ...
                            html:inline($config, ., ("tei-body2", css:map-rend-to-class(.)), .)
                        )
                    ...
                    case element(text) return
                        html:body($config, ., ("tei-text", css:map-rend-to-class(.)), (root(.)//entities, .))
                    ...
                    case element(respStmt) return
                        if ($parameters?mode="metadata") then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-respStmt", css:map-rend-to-class(.)), $content)
                        else
                            $config?apply($config, ./node())
                    case element(sourceDesc) return
                        if ($parameters?header='short') then
                            html:link($config, ., ("tei-sourceDesc", "header-short", css:map-rend-to-class(.)), "Facsimile", p/idno[@type="URI"], "_blank", map {})
                        else
                            $config?apply($config, ./node())
