    ...
    $input !         (
            ...
            return
                    ...
                    case element(closer) return
                        epub:block($config, ., ("tei-closer2", css:map-rend-to-class(.)), .)
                    ...
                    case element(postscript) return
                        (
                            ...
                            epub:block($config, ., ("tei-postscript3", css:map-rend-to-class(.)), .)
                        )

                    case element(dateline) return
                        epub:block($config, ., css:get-rendition(., ("tei-dateline2", css:map-rend-to-class(.))), .)
                    ...
                    case element(opener) return
                        epub:block($config, ., ("tei-opener2", css:map-rend-to-class(.)), .)
                    ...
                    case element(body) return
                        if ($parameters?mode='facets') then
                            ...
                            (
                                ...
                                epub:block($config, ., ("tei-body6", css:map-rend-to-class(.)), .)
                            )
                    ...
                    case element(place) return
                        (
                            ...
                            if (location/geo) then
                                ...
                                (),
                            epub:block($config, ., ("tei-place4", css:map-rend-to-class(.)), string-join(location/* except location/geo, ', ')),
                            epub:block($config, ., ("tei-place5", css:map-rend-to-class(.)), note/node())
                        )
                    ...
                    case element(person) return
                        (
                            ...
                            if (birth or death or occupation) then
                                epub:block($config, ., ("tei-person3", css:map-rend-to-class(.)), (occupation, birth, death))
                            else
                                (),
                            if (idno) then
                                epub:block($config, ., ("tei-person4", css:map-rend-to-class(.)), idno)
                            else
                                (),
                            epub:block($config, ., ("tei-person5", css:map-rend-to-class(.)), note/node())
                        )
