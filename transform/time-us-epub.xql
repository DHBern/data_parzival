...
module namespace model="http://www.tei-c.org/pm/models/time-us/epub";
    ...
    $input !         (
            ...
            return
                        ...
                        if ($parameters?header='short') then
                            ...
                            if ($parameters?mode="metadata") then
                                (
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader2", css:map-rend-to-class(.)), $content),
                                    let $params := 
                                        map {
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader3", css:map-rend-to-class(.)), $content),
                                    let $params := 
                                        map {
                                            "content": .
                                        }
                    ...
                    case element(publicationStmt) return
                        if ($parameters?header='short') then
                            epub:block($config, ., ("tei-publicationStmt1", css:map-rend-to-class(.)), p)
                        else
                            (: More than one model without predicate found for ident publicationStmt. Choosing first one. :)
                            epub:block($config, ., ("tei-publicationStmt2", css:map-rend-to-class(.)), availability/licence)
                    ...
                    case element(fileDesc) return
                        if ($parameters?header='short') then
                            (
                                ...
                                epub:block($config, ., ("tei-fileDesc2", "header-short", css:map-rend-to-class(.)), sourceDesc),
