...
module namespace model="http://www.tei-c.org/pm/models/pagedtest/print";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(l) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., css:get-rendition(., ("tei-l", css:map-rend-to-class(.))), $content)
