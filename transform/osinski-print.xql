...
module namespace model="http://www.tei-c.org/pm/models/osinski/print";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(entryFree) return
                        html:block($config, ., ("tei-entryFree", css:map-rend-to-class(.)), .)
                    ...
                    case element(respStmt) return
                        printcss:alternate($config, ., ("tei-respStmt", css:map-rend-to-class(.)), ., persName, resp)
