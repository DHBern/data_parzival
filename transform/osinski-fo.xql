(:~
    ...
    ODD: /db/apps/parzival/odd/osinski.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/pm/models/osinski/fo";
            ...
            return
                    ...
                    case element(ref) return
                        if (parent::cit or parent::def) then
                            ...
                            fo:inline($config, ., ("tei-ref1", "ref-author", css:map-rend-to-class(.)), .)
                        else
                            if (not(@target)) then
                    ...
                    case element(entryFree) return
                        fo:block($config, ., ("tei-entryFree", css:map-rend-to-class(.)), .)
                    ...
                    case element(respStmt) return
                        fo:alternate($config, ., ("tei-respStmt", css:map-rend-to-class(.)), ., persName, resp)
