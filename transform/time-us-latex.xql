...
module namespace model="http://www.tei-c.org/pm/models/time-us/latex";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(teiHeader) return
                        if ($parameters?mode="metadata") then
                            (
                                ...
                                return
                                                                latex:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader2", css:map-rend-to-class(.)), $content),
                                let $params := 
                                    map {
                                ...
                                return
                                                                latex:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader3", css:map-rend-to-class(.)), $content),
                                let $params := 
                                    map {
                                        "content": .
                                    }
                                ...
                                return
                                                                latex:text(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader4", css:map-rend-to-class(.)), $content),
                                let $params := 
                                    map {
                                ...
                                return
                                                                latex:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader5", css:map-rend-to-class(.)), $content)
                            )

                        else
                            if ($parameters?mode='title') then
                                latex:inline($config, ., ("tei-teiHeader6", css:map-rend-to-class(.)), (fileDesc/titleStmt/title[1]))
                            else
                                latex:metadata($config, ., ("tei-teiHeader7", css:map-rend-to-class(.)), .)
                    ...
                    case element(pb) return
                        latex:omit($config, ., css:get-rendition(., ("tei-pb", css:map-rend-to-class(.))), .)
                    ...
                    case element(w) return
                        ...
                        return
                                                latex:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-w", css:map-rend-to-class(.)), $content)
                    ...
                    case element(fileDesc) return
                        if ($parameters?header='short') then
                            (
                                ...
                                latex:block($config, ., ("tei-fileDesc2", "header-short", css:map-rend-to-class(.)), sourceDesc),
                    ...
                    case element(body) return
                        (
                            ...
                            latex:inline($config, ., ("tei-body2", css:map-rend-to-class(.)), .)
                        )
                    ...
                    case element(text) return
                        latex:body($config, ., ("tei-text", css:map-rend-to-class(.)), (root(.)//entities, .))
                    ...
                    case element(respStmt) return
                        if ($parameters?mode="metadata") then
                            ...
                            return
                                                        latex:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-respStmt", css:map-rend-to-class(.)), $content)
                        else
                            $config?apply($config, ./node())
                    case element(sourceDesc) return
                        if ($parameters?header='short') then
                            latex:link($config, ., ("tei-sourceDesc", "header-short", css:map-rend-to-class(.)), "Facsimile", p/idno[@type="URI"], map {"target": "_blank"})
                        else
                            $config?apply($config, ./node())
                    case element() return
