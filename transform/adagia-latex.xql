...
module namespace model="http://www.tei-c.org/pm/models/adagia/latex";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(pb) return
                        ...
                        return
                                                latex:pass-through(map:merge(($config, map:entry("template", true()))), ., css:get-rendition(., ("tei-pb", css:map-rend-to-class(.))), $content)
