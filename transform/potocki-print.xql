            ...
            return
                    ...
                    case element(note) return
                        if (@type='ling') then
                            ...
                            return
                                                        printcss:note(map:merge(($config, map:entry("template", true()))), ., ("tei-note1", "ling", css:map-rend-to-class(.)), $content, (), ())
                        else
                            if ($parameters?view="introduction" and @type="introduction") then
                                ...
                                if (@type="introduction") then
                                    ...
                                    printcss:note($config, ., ("tei-note4", css:map-rend-to-class(.)), ., @place, @n)
                    ...
                    case element(div) return
                        if ($parameters?view='introduction') then
                            html:block($config, ., ("tei-div1", css:map-rend-to-class(.)), .//note[@type='introduction'])
                        else
                    ...
                    case element(person) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person", "person", css:map-rend-to-class(.)), $content)
                        ...
                        if (note) then
                            ...
                            if (note) then
                                (
                                    ...
                                    if (note) then
                                        printcss:note($config, ., ("tei-distinct3", css:map-rend-to-class(.)), note, (), ())
                                    else
                                        ()
                                )
