...
module namespace model="http://www.tei-c.org/pm/models/pagedtest/epub";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(l) return
                        ...
                        return
                                                epub:block(map:merge(($config, map:entry("template", true()))), ., css:get-rendition(., ("tei-l", css:map-rend-to-class(.))), $content)
